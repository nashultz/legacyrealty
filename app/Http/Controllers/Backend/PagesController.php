...
use Legacy\Http\Requests\StorePageRequest;
use Legacy\Http\Requests\UpdatePageRequest;
use Legacy\Page;
...
class PagesController extends Controller
{
    ...
    public function store(StorePageRequest $request)
    {
        ...
        return redirect(route('mylegacy.pages.index'))->with('status','Page has been created.');
    }
    ...
    public function update(UpdatePageRequest $request, $id)
    {
        ...
        return redirect(route('mylegacy.pages.edit',$page->id))->with('status','Page has been updated.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect(route('mylegacy.pages.index'))->with('status','Page has been deleted.');
    }
    ...
    protected function updatePageOrder(Page $page, Request $request)
    {
        if($request->has('order','orderPage'))
        {
            ...
            {
                return redirect(route('mylegacy.pages.edit', $page->id))->withInput()->withErrors([

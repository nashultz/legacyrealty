...
use Legacy\Http\Requests\DeleteUserRequest;
...
class UsersController extends Controller
{
    ...
    public function store(StoreUserRequest $request)
    {
        ...
        return redirect(route('mylegacy.users.index'))->with('status','User has been created.');
    }
    ...
    public function update(UpdateUserRequest $request, $id)
    {
        ...
        return redirect(route('mylegacy.users.edit',$user->id))->with('status','User has been updated.');
    }
    ...
    public function destroy(DeleteUserRequest $request, $id)
    {
        ...
        return redirect(route('mylegacy.users.index'))->with('status','User has been deleted.');
    }
}
